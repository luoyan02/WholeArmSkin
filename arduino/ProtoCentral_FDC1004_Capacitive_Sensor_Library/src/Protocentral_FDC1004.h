...
class FDC1004
{
 public:
    ...
    uint8_t configureMeasurementDifferential(uint8_t measurement, uint8_t poschannel, uint8_t negchannel);
    ...
    uint8_t measureChannel(uint8_t poschannel, uint8_t negchannel, uint8_t capdac, uint16_t * value, uint8_t isdiff);
