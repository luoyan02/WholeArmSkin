...
void loop() {
  ...
  c[53] = gettaxelreading( ONEA );
  c[55] = gettaxelreading( ONEB );
  c[54] = gettaxelreading( TWOA );
  c[52] = gettaxelreading( TWOB );
  

  
//  uint8_t counter;
//  for(counter = 25; counter<=27; counter++)
//  {
