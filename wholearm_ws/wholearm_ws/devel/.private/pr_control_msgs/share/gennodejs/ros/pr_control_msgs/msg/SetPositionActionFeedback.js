...
let SetPositionFeedback = require('./SetPositionFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class SetPositionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SetPositionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetPositionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetPositionActionFeedback(null);
    ...
    data.feedback = SetPositionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPositionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SetPositionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SetPositionFeedback()
    }
...
module.exports = SetPositionActionFeedback;
