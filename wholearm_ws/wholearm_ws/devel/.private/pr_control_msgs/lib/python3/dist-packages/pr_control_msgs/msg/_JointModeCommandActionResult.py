...
"""autogenerated by genpy from pr_control_msgs/JointModeCommandActionResult.msg. Do not edit."""
import codecs
import sys
...
class JointModeCommandActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "pr_control_msgs/JointModeCommandActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_control_msgs/JointModeCommandResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointModeCommandActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pr_control_msgs.msg.JointModeCommandResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr_control_msgs.msg.JointModeCommandResult()
