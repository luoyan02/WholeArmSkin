...
"""autogenerated by genpy from pr_control_msgs/JointGroupCommandActionResult.msg. Do not edit."""
import codecs
import sys
...
class JointGroupCommandActionResult(genpy.Message):
  _md5sum = "7c3f2070efdd9bf96ebb6550bfb2bc78"
  _type = "pr_control_msgs/JointGroupCommandActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_control_msgs/JointGroupCommandResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointGroupCommandActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pr_control_msgs.msg.JointGroupCommandResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr_control_msgs.msg.JointGroupCommandResult()
