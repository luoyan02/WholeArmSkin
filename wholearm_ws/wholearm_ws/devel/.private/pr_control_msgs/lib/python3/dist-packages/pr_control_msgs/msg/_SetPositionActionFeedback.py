...
"""autogenerated by genpy from pr_control_msgs/SetPositionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SetPositionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "pr_control_msgs/SetPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_control_msgs/SetPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetPositionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pr_control_msgs.msg.SetPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr_control_msgs.msg.SetPositionFeedback()
