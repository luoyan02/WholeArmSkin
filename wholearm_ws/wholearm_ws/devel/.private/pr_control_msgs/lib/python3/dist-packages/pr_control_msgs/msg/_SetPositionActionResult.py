...
"""autogenerated by genpy from pr_control_msgs/SetPositionActionResult.msg. Do not edit."""
import codecs
import sys
...
class SetPositionActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "pr_control_msgs/SetPositionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_control_msgs/SetPositionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetPositionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pr_control_msgs.msg.SetPositionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pr_control_msgs.msg.SetPositionResult()
