...
"""autogenerated by genpy from pr_control_msgs/JointGroupCommandActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class JointGroupCommandActionFeedback(genpy.Message):
  _md5sum = "098576e66a95c9177eec121a5e0b58b2"
  _type = "pr_control_msgs/JointGroupCommandActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pr_control_msgs/JointGroupCommandFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointGroupCommandActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pr_control_msgs.msg.JointGroupCommandFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pr_control_msgs.msg.JointGroupCommandFeedback()
