...
"""autogenerated by genpy from pr_control_msgs/JointGroupCommandFeedback.msg. Do not edit."""
import codecs
import sys
...
class JointGroupCommandFeedback(genpy.Message):
  _md5sum = "1a41b9418bc88d43721c4db353e5e3a8"
  _type = "pr_control_msgs/JointGroupCommandFeedback"
...
"""
  __slots__ = ['header','joint_names','desired','actual']
  _slot_types = ['std_msgs/Header','string[]','trajectory_msgs/JointTrajectoryPoint','trajectory_msgs/JointTrajectoryPoint']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,joint_names,desired,actual
    ...
    """
    if args or kwds:
      super(JointGroupCommandFeedback, self).__init__(*args, **kwds)
