...
class JointGroupCommandFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointGroupCommandFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointGroupCommandFeedback(null);
...
module.exports = JointGroupCommandFeedback;
