...
LowPassFilter::LowPassFilter(double sampling_rate, double cutoff_frequency, int dof)
{
...
std::vector<double> LowPassFilter::getFilteredEffort(std::vector<double> &tau_J_raw)
{
